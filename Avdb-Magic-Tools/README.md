...
标签栏采用 Emby“首页/收藏”同款的胶囊式横向滚动样式，预告片隐藏选项已并入“主题 & UI”，可在同一标签中配置。
...
- 设置页标签按“图片 → 演员 → 主题 & UI → STRM → AVDB”排列，标签栏使用 Emby“首页/收藏”同款胶囊式横向滚动样式；“演员”标签合并演员写真/头像与演员墙两个设置区，栏目之间保留垂直间距和分隔线。
