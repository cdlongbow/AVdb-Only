...
设置页将 AVDB 服务地址和 API Key 单独放在最后的“AVDB”标签；依赖 AVDB 的“海报/封面 & 剧照”
以及“演员写真 & 头像”标签会在各自底部说明所需配置。预告片隐藏选项已并入“主题/UI”标签。
...
在 Emby 控制台打开“插件 → Avdb Magic Tools → 设置”，可以通过“海报/封面 & 剧照”“演员写真 & 头像”“主题/UI”、
“演员墙”“STRM 媒体信息预提取”“AVDB”标签切换分类；预告片隐藏选项已并入“主题/UI”，可在同一标签中配置。
...
- 设置页标签按“海报/封面 & 剧照 → 演员写真 & 头像 → 主题/UI → 演员墙 → STRM 媒体信息预提取 → AVDB”排列，栏目之间增加垂直间距和
